...
class GridImage(val cellSize: Int = 1, val defaultColor: Color = Color.WHITE) {
    ...
    fun toImage(): BufferedImage {
        ...
        val image = BufferedImage((xMax-xMin +1)*cellSize3d, (yMax-yMin +1)*cellSize3d, BufferedImage.TYPE_INT_RGB)
        ...
        if( graphics != null ) {
            ...
            data.forEach {
                ...
                graphics.fill3DRect((coord.x-xMin)*cellSize3d, (coord.y-yMin)*cellSize3d, cellSize3d, cellSize3d, true)
...
fun main() {
    ...
    GridImage.animate(frames, "/tmp/test.gif", 500)
}